...
/* ut_ordt */
extern CU_TestInfo ordt_tests[];
extern int ut_ordt_init(void);
extern int ut_ordt_cleanup(void);
...
/* dag tasks */
extern CU_TestInfo ut_dtask_tests[];
extern int ut_dtask_init(void);
extern int ut_dtask_cleanup(void);
...
CU_SuiteInfo suites[] = {
    ...
    { "ORDT", ut_ordt_init, ut_ordt_cleanup, NULL, NULL, ordt_tests },
    { "DEADLINES", ut_dl_init, ut_dl_cleanup, NULL, NULL, ut_dl_tests },
    { "DAG TASKS", ut_dtask_init, ut_dtask_cleanup, NULL, NULL, ut_dtask_tests },
    CU_SUITE_INFO_NULL
};
